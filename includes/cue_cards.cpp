...
const vector<pair<string, string>> cueCards = {
    ...
    {"How are the frequency and the period of a wave related?", "The frequency and period of a wave are inverses of each other\nIf a wave has frequency 2 Hz, then it has period 0.5 s"},
    {"How does temperature affect the speed of waves?", "As the temperature of a medium increases, the motion of the particles increases, transferring vibrational energy faster, increasing the speed of the wave"},
    {"In wave theory, what is interference? Define constructive and destructive interference", "Interference is the creation of the resultant wave when two or more waves overlap at a particular point\nConstructive interference occurs when the resultant wave has greater amplitude than the constituent waves at a particular point\nDestructive interference occurs when the resultant wave has lesser amplitude than the constituent waves at a particular point"},
    {"In terms of wave interference, what is the principle of superposition?", "When two or more waves interfere, the resultant net wave's amplitude at a particular point is equal to the vector sum of all amplitude of the waves going through that point at that point"},
    {"In terms of waves, what is fixed end and free end reflection?", "Fixed end reflection occurs when one end of a wave is fixed, the wave is reflected in the opposite direction upon reaching the end, continuing with an inverted amplitude (upside down)\nFree end reflection occurs when the end of the wave is allowed to move freely, resulting in a reflection of the wave in the opposite direction with equal amplitude"},
    {"In terms of wave interference, what is a beat?", "A beat occurs when two waves of different frequencies interfere. There are periodic moments of constructive and destructive interference, creating a new \"wave\" with frequency of the difference of frequencies between the two original waves"},
    {"What is a standing wave? What is meant by the nodes and antinodes of a standing wave?", "A standing wave forms when two waves meet head on, travelling in opposite directions\nThe interference pattern creates a wave which seems to stand in place\nNodes are points on the standing wave which do not vibrate or move\nAntinodes sit between nodes and have maximum movement"},
    {"What is meant by the harmonics of a standing wave? When can standing waves occur with both ends fixed/unfixed and only one end fixed?", "Standing waves can only occur in certain frequencies, which are all multiples of the base frequency: the fundemental frequency, or 1st harmonic. The other harmonics are known as the 2nd harmonic, 3rd harmonic, etc. They are also known as the 1st overtone, 2nd overtone, etc.\nWhen both ends are open/closed, standing waves occur at multiples of 1/2 the frequency of the original wave (1/2, 1, 3/2, ...), being the 1st, 2nd, 3rd harmonics ...\nWhen only one end of the wave is fixed, the wave occurs at multiples of 1/2 plus 1/4, (1/4, 3/4, 5/4, ...) being the 1st, 3rd, 5th harmonics ..."},
    {"In wave theory, what is meant by damping?", "Damping occurs when a wave's amplitude decreases as a result of energy absorption or destructive interference"}
};
