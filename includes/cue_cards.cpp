...
const vector<pair<string, string>> cueCards = {
    ...
    {"How does temperature affect the speed of waves?", "As the temperature of a medium increases, the motion of the particles increases, transferring vibraitonal energy faster, increasing the speed of the wave"}
};
